package com.fingressYaml.transformer;
...
public class TransformerActivemqToJdbcYaml2 implements Processor {

	Log log = LogFactory.getLog(TransformerActivemqToJdbcYaml2.class);
