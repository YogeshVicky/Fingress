package com.fingress.googleSheets.transformer;
...
public class GoogleSheetsTransformer2 implements Processor {
	Log log = LogFactory.getLog(GoogleSheetsTransformer2.class);
